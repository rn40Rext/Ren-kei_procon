      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.menuContainer}>
          ...
          <View style={styles.menuGrid}>
            <TouchableOpacity style={styles.menuCard} onPress={() => navigation.navigate('Scoring')}>
            ...
            <TouchableOpacity style={styles.menuCard} onPress={() => navigation.navigate('Community')}>
            ...
            <TouchableOpacity style={styles.menuCard} onPress={() => navigation.navigate('Request')}>
            ...
            <TouchableOpacity style={styles.menuCard} onPress={() => navigation.navigate('Mypage')}>
