...
const styles = StyleSheet.create({
  ...
  brandName: { ...typography.bodyStrong, color: colors.textPrimaryOnIndigo, fontSize: 16 },
  ...
  heroTitle: { ...typography.titleSerif, color: colors.textPrimaryOnIndigo, fontSize: 24 },
  heroSub: { ...typography.caption, color: colors.textSecondaryOnIndigo, marginTop: spacing.xs },
  ...
  searchInput: { flex: 1, marginLeft: spacing.sm, color: colors.textPrimaryOnIndigo, ...typography.body, fontSize: 14 },
  ...
  tagText: { fontSize: 13, color: colors.textSecondaryOnIndigo },
  ...
  cardTitle: { ...typography.bodyStrong, color: colors.textPrimaryOnIndigo, fontSize: 16, marginBottom: spacing.sm },
  ...
  modalTitle: { ...typography.headingSerif, color: colors.textPrimaryOnIndigo },
  ...
  input: { backgroundColor: colors.indigoRaised, borderWidth: 1, borderColor: colors.indigoLine, padding: spacing.md, borderRadius: radius.sm, marginBottom: spacing.xl, color: colors.textPrimaryOnIndigo, ...typography.body },
  ...
  detailNavTitle: { fontSize: 15, fontWeight: '700', flex: 1, color: colors.textPrimaryOnIndigo },
  ...
  comText: { fontSize: 14, lineHeight: 21, color: colors.textSecondaryOnIndigo },
  ...
  textInput: { flex: 1, backgroundColor: colors.indigoRaised, borderRadius: radius.pill, paddingHorizontal: spacing.lg, height: 44, color: colors.textPrimaryOnIndigo },
