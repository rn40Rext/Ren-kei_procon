...
const styles = StyleSheet.create({
  ...
  centered: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24, backgroundColor: colors.indigoDeep },
  title: { fontSize: 26, fontWeight: "bold", color: colors.textPrimaryOnIndigo, marginBottom: 6 },
  lead: { fontSize: 13, color: colors.textSecondaryOnIndigo, marginBottom: 16 },
  totalCard: { backgroundColor: colors.indigo, borderWidth: 1, borderColor: colors.indigoLine, borderRadius: 16, padding: 20, alignItems: "center", marginBottom: 20 },
  ...
  totalUnit: { color: colors.textMuted, marginTop: -6 },
  version: { color: colors.textMuted, fontSize: 11, marginTop: 8 },
  sectionTitle: { fontSize: 16, fontWeight: "bold", color: colors.textPrimaryOnIndigo, marginTop: 8, marginBottom: 10 },
  itemRow: { marginBottom: 12 },
  itemHeader: { flexDirection: "row", justifyContent: "space-between", marginBottom: 4 },
  itemLabel: { color: colors.textPrimaryOnIndigo, fontWeight: "600" },
  itemNote: { color: colors.textMuted, fontSize: 11, fontWeight: "normal" },
  itemValue: { fontWeight: "bold" },
  barTrack: { height: 10, backgroundColor: colors.indigoRaised, borderRadius: 5, overflow: "hidden" },
  barFill: { height: 10, borderRadius: 5 },
  feedback: { borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1 },
  ...
  feedbackTag: { fontSize: 11, fontWeight: "bold", color: colors.textMuted, marginBottom: 2 },
  feedbackText: { color: colors.textPrimaryOnIndigo, fontSize: 14 },
  gameCard: { borderWidth: 1, borderColor: colors.indigoLine, borderRadius: 12, padding: 14, marginTop: 12, marginBottom: 20, backgroundColor: colors.indigo },
  gameLabel: { fontSize: 12, color: colors.textSecondaryOnIndigo, fontWeight: "bold" },
  gameValue: { fontSize: 28, fontWeight: "900", color: colors.goldBright },
  gameCounts: { fontSize: 12, color: colors.textSecondaryOnIndigo, marginTop: 2 },
  gameNote: { fontSize: 11, color: colors.textMuted, marginTop: 6 },
  primaryButton: { backgroundColor: colors.gold, paddingVertical: 14, borderRadius: 12, alignItems: "center", marginBottom: 10 },
  primaryButtonAlt: { backgroundColor: colors.aka, paddingVertical: 14, borderRadius: 12, alignItems: "center", marginBottom: 10 },
  primaryButtonText: { color: colors.textOnGold, fontWeight: "bold", fontSize: 15 },
  secondaryButton: { borderWidth: 1, borderColor: colors.indigoLine, paddingVertical: 12, borderRadius: 12, alignItems: "center", backgroundColor: colors.indigo },
  secondaryButtonText: { color: colors.textPrimaryOnIndigo, fontWeight: "600" },
  muted: { color: colors.textMuted, fontSize: 13, marginTop: 8 },
  errorText: { color: colors.aka, marginBottom: 16, textAlign: "center" },
});
