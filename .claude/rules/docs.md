...
Word 原本 `Ren-Kei_システム仕様書_基本設計書_v0.3.docx` から生成した**正典**です。ここを書き換えると、原本と食い違って正典が失われます。
...
**仕様と実装が食い違っている場合、勝手にどちらかへ寄せないでください。** [docs/status/gap-analysis.md](../../docs/status/gap-analysis.md) に差分として記録し、人間に判断を仰ぎます。

## 各ディレクトリの役割

| パス | 役割 | 編集 |
| --- | --- | --- |
| `docs/spec/` | 製品仕様書 v0.3（正典） | ✗ 禁止 |
